...
class LSTMNet(nn.Module):
    def __init__(self, conv_features, lstm_hidden, lstm_layers, make_predictor, drop_rate):
        super(LSTMNet, self).__init__()

        #conv_features += 4
        self.lstm = nn.LSTM(input_size = conv_features, hidden_size = lstm_hidden, num_layers = lstm_layers, bias = True, batch_first = True, dropout = drop_rate)
        self.predictor = make_predictor(lstm_hidden, 2)
